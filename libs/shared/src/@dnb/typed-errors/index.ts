...
export class AlreadyExistsError extends PublicError {
  constructor(
    message = ALREADY_EXISTS_ERROR.message,
    type = ALREADY_EXISTS_ERROR.type,
    internalMessage?: string
  ) {
    super(message, 409, type, internalMessage);
  }
}
